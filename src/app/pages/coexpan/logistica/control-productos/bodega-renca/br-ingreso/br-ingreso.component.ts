...
import { AlertController, IonButton, IonTextarea, LoadingController } from '@ionic/angular';
...
@Component({
  ...
  templateUrl: './br-ingreso.component.html',
  styleUrls: ['./br-ingreso.component.scss']
})
export class BrIngresoComponent implements OnInit, AfterViewInit {
