...
import { IonButton, IonTextarea, AlertController, LoadingController } from '@ionic/angular';
import { CxpService } from '../../../../../../providers/web-services/cxp/cxp.service';
import { RegistrosModel, GetConsultaModelV2, EstadoIngresoV2Model } from '../../../../../../models/Registros.model';

@Component({
  selector: 'app-bp-salida-mercancia',
  templateUrl: './bp-salida-mercancia.component.html',
  styleUrls: ['./bp-salida-mercancia.component.scss']
})
export class BpSalidaMercanciaComponent implements OnInit {
